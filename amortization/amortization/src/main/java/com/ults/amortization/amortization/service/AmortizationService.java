package com.ults.amortization.amortization.service;
...
import com.ults.amortization.amortization.model.Payment;
...
public class AmortizationService {
    ...
    /**
     * Modifies reference to monthlyAmortizationSchedule to resolve values of empty
     * fields.
     * 
     * @param monthlyAmortizationSchedule object containing all required loan
    ...
    public void initializeUnknownFields(MonthlyAmortizationSchedule monthlyAmortizationSchedule) {
        ...
        double initialBalance = monthlyAmortizationSchedule.getloanAmount();
        ...
        // List<Payment> paymentList = calculatePaymentList(startDate, initialBalance,
        // durationInMonths, paymentType,
